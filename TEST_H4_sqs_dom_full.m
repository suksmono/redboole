...
% 5. Extract Ising params {b, hi, Jij}, then solve using SA
% ----------------------------------------------------------------------
clear all;
addpath functions;
...
Hkq=expand(simplify( ...
                ...
                { s2q(q11), s2q(q12), s2q(q13),s2q(q14), ...
                  s2q(q21), s2q(q22) ,s2q(q23),s2q(q24), ...
                  s2q(q31), s2q(q32) ,s2q(q33),s2q(q34), ...
                  s2q(q41), s2q(q42) ,s2q(q43),s2q(q44) ...
                  }...
                )...
            ));
disp(sprintf('Hkq: \n%s',char(Hkq)));
...
H2q=simplify( ...
     subs( Hkq, ...
          { q(1,1)*q(1,2), q(1,1)*q(1,3), q(1,1)*q(1,4), q(1,2)*q(1,3), q(1,2)*q(1,4),q(1,3)*q(1,4), ...
            q(2,1)*q(2,2), q(2,1)*q(2,3), q(2,1)*q(2,4), q(2,2)*q(2,3), q(2,2)*q(2,4),q(2,3)*q(2,4), ...
            q(3,1)*q(3,2), q(3,1)*q(3,3), q(3,1)*q(3,4), q(3,2)*q(3,3), q(3,2)*q(3,4),q(3,3)*q(3,4), ...
            q(4,1)*q(4,2), q(4,1)*q(4,3), q(4,1)*q(4,4), q(4,2)*q(4,3), q(4,2)*q(4,4),q(4,3)*q(4,4) ...
            }, ...
          { q(1,5), q(1,6), q(1,7), q(1,8), q(1,9), q(1,10), ...
            q(2,5), q(2,6), q(2,7), q(2,8), q(2,9), q(2,10), ...
            q(3,5), q(3,6), q(3,7), q(3,8), q(3,9), q(3,10), ...
            q(4,5), q(4,6), q(4,7), q(4,8), q(4,9), q(4,10) ...
            } ...
        ) ...
...
H2s = simplify( ...
            subs(H2q, ...
                { q11,q12,q13,q14,q15,q16,q17,q18,q19,q110, ... 
                  q21,q22,q23,q24,q25,q26,q27,q28,q29,q210, ...
                  q31,q32,q33,q34,q35,q36,q37,q38,q39,q310, ...
                  q41,q42,q43,q44,q45,q46,q47,q48,q49,q410 ...
                  }, ...
                { q2s(s11), q2s(s12),q2s(s13),q2s(s14),q2s(s15),q2s(s16),q2s(s17),q2s(s18),q2s(s19),q2s(s110), ...
                  q2s(s21), q2s(s22),q2s(s23),q2s(s24),q2s(s25),q2s(s26),q2s(s27),q2s(s28),q2s(s29),q2s(s210), ...
                  q2s(s31), q2s(s32),q2s(s33),q2s(s34),q2s(s35),q2s(s36),q2s(s37),q2s(s38),q2s(s39),q2s(s310), ...
                  q2s(s41), q2s(s42),q2s(s43),q2s(s44),q2s(s45),q2s(s46),q2s(s47),q2s(s48),q2s(s49),q2s(s410)  ...
                  }...
                )...
            );
%
...
[cx,tx]=coeffs(H2s,[ s11 s12 s13 s14 s15 s16 s17 s18 s19 s110 ...
                     s21 s22 s23 s24 s25 s26 s27 s28 s29 s210 ...
                     s31 s32 s33 s34 s35 s36 s37 s38 s39 s310 ...
                     s41 s42 s43 s44 s45 s46 s47 s48 s49 s410 ...
                     ]);
...
if length(vE)>1
    imagesc(1);
    plot(vE);
    xlabel('Time (Iteration)'); ylabel('Energy');
end;
% end
